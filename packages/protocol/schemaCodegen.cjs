...
var schemaUri =
  'https://jenkins.ivyteam.io/job/core_json-schema/job/release%252F12.0/lastSuccessfulBuild/artifact/build/schema/target/editor-ts/12.0/variables-tsgen.json';
