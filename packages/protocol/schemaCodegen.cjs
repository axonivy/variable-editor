...
var schemaUri =
  'https://jenkins.ivyteam.io/job/core_json-schema/job/master/lastSuccessfulBuild/artifact/workspace/ch.ivyteam.ivy.variables.editor.lsp.schema/target/schema/variables/13.1.0/variables-tsgen.json';
