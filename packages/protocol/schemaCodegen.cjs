...
var schemaUri = 'https://jenkins.ivyteam.io/job/core_json-schema/job/master/lastSuccessfulBuild/artifact/workspace/ch.ivyteam.ivy.variables.editor.lsp.schema/target/editors.ts/14.0/variables-tsgen.json';
